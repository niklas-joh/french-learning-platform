...
Can you conduct a detailed analysis of the approach, impacted files, dependencies, and coding suggestions for for the referenced file . Adhere to @/docs/development_docs/tasks/phase-3_AI_integration/phase3_complete_summary.md and @/docs/development_docs/tasks/phase-3_AI_integration/phase3_master_tracking.md 

Make sure it is future-proof, following best coding standards, and reuses existing content whenever possible. Follow KISS, Single Responsibility Principle (SRP), and YAGNI.
...
1. Implement the code for the current task, adding comprehensive JSDOCs as you go along
2. Review your code for consistency, logic and potential flaws
3. Analyse if changes are needed to other files
4. Update @/docs\development_docs\tasks\phase-3_AI_integration\phase3_master_tracking.md , @/docs\development_docs\tasks\phase-3_AI_integration\phase3_complete_summary.md , and the subtask and other documentation plans with our progress.
5. Update @/docs\development_docs\architecture\system_architecture.mermaid, @/docs\development_docs\architecture\database_schema.mermaid  or other high-level overview documents
...
## ACT MODE CLAUDE CODE
If you have found tasks for future implementation, add them to @/docs/development_docs/future_implementation_considerations.md  before working on other activities and capture/update your sub-tasks. Then proceed to work on your identified sub-task one by one, following this approach for each subtask:

1. Implement the code for the current task, adding comprehensive JSDOCs as you go along
2. Regularly Review your code for consistency, logic and potential flaws
3. Analyse if changes are needed to other files
4. Update @/docs\development_docs\architecture\system_architecture.mermaid, @/docs\development_docs\architecture\database_schema.mermaid  or other high-level overview documents
...
6. Push to git with comprehensive message and git body in a separate file
7. Condense your context window using /compact, keeping key information, detailed if needed, to continue on the next subtask. Keep to atomic changes, repeating these instructions.
